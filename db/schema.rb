...
ActiveRecord::Schema[8.1].define(version: 2026_02_08_013529) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "onboarding_step", default: "hamburger_intro", null: false
