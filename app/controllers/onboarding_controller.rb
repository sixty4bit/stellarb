...
class OnboardingController < ApplicationController
  ...
  def skip
    ...
    redirect_to inbox_index_path, notice: "Tutorial skipped. You can replay it anytime from settings."
  end
  ...
  def reset
    ...
    redirect_to inbox_index_path, notice: "Tutorial reset. Welcome back!"
  end
  ...
  def redirect_to_step_target
    if current_user.onboarding_complete?
      redirect_to inbox_index_path, notice: "Congratulations! You've completed the tutorial. Time to make some credits!"
      return
    end
